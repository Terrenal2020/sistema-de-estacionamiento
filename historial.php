...
<?php
    ...
    <div>
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item ">
                <a class="nav-link  active disabled" href="historial.php">Historial de ocupacion </a>
...
<div class="datos">
    ...
    <h3>Historial del Estacionamiento por fechas</h3>
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th>ocupacion</th>
                <th>Total Efectivo por pago</th>
                <th>Fecha</th>
            
            </tr>
        </thead>
        
        <?php foreach ($conexion->query('SELECT * from espacioshistorial') as $row){?>
        <tr>
            <td><?php echo $row['id_espacios'] ?></td>
            <td><?php echo $row['totalOcupaciones'] ?></td>
