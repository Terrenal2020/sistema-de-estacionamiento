...
<body> <?php
    ...
    <div>
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item ">
                <a class="nav-link  active disabled" href="registroVehiculoCajero.php">Registro de vehiculos </a>
            </li>
...
<form action="guardarVehiculoCajero.php" name="f1" method="post" enctype="multipart/form-data">
<div class="row">
