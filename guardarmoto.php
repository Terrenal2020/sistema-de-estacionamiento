<?php
      ...
      if($imagenValida) {
    mysqli_query($conexion, "INSERT INTO motos(marca,modelo,placas,conductor,foto) VALUES ('$marca','$modelo','$placas','$conductor','$imagenNombre')");
    mysqli_close($conexion);
    //echo $codigo;
      
    echo  "<SCRIPT >
alert('Moto guardado exitosamente');
