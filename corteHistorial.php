...
<?php
    ...
    <div>
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item ">
                <a class="nav-link active disabled" href="corteHistorial.php">Corte de Caja </a>
...
<table class="table table-striped" border="3">
                        ...
                        <h5><b><?php echo "Total = $".$total.""; ?></b></h5>
                        
                 </table>
                 <a href="CorteCajaReset.php"><button type="button" class="btn btn-warning">Corte Caja
                    </button></a>
                 <a href="pdfCorteCaja.php"><button type="Button" class="btn btn-outline-info" title="Imprimir Pdf">
                    <span><i class="fas fa-print"></i></span></button></a>
</div>
