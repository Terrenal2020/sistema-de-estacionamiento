...
<body>  <?php
    ...
    <div>
        ...
        <li class="nav-item">
            ...
            <li class="nav-item ">
                <a class="nav-link active disabled" href="gestionVehiculos.php">Gestion de vehiculos </a>
            </li>
            <li class="nav-item ">
...
<form action="guardarVehiculo.php" name="f1" method="post" enctype="multipart/form-data">
<div class="row">
...
<div class="datos">
    ...
    <table class="table table-striped">
        ...
        <?php foreach ($conexion->query('SELECT * from autos') as $row){?>
        <tr>
            ...
            <td><a href=eliminarVehiculo.php?id=<?php echo $row['id']?>><button type=Button
                        class='btn btn-outline-danger'>
                        <span><i class='fas fa-trash-alt'></i></span></button></a></td>
            <td><a href=modificarVehiculos.php?id=<?php echo $row['id']?>><button type=Button
