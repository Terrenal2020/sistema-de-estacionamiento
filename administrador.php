...
<body>
    ...
    <div>
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white" href="gestionMotos.php">Gestion de Motos </a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white" href="gestionConductorAdmin.php">Gestion de Conductores</a>
...
<div align="center">
    ...
    <h3>Bienvenido  Administrador:<span class="text-danger"><?php echo$_SESSION['usuario']?></span></h3>
