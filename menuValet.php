  ...
  <div class="clockdate-wrapper">
    ...
    <div id="date"></div>
        ...
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white" href="consultaEspacioValet.php">CONSULTA DE ESPACIO </a>
...
<div align="center">
    ...
    <h3>Bienvenido  VALET:<span class="text-danger"><?php echo$_SESSION['usuario']?></span></h3>
