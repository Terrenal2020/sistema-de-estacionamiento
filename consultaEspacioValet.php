  ...
  <div class="clockdate-wrapper">
    ...
    <div id="date"></div>
        ...
        <ul class="nav nav-tabs card-header-tabs" style="background-color: #4254b5;">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="menuValet.php">Inicio</a>
            </li>

            <li class="nav-item ">
                <a class="nav-link  active disabled" href="">CONSULTA DE ESPACIO </a>
                         ...
                         foreach ($conexion->query('SELECT * from espacios') as $row){
                           ...
                           ?>
                            ...
                            <?php } else if($id<=20 and $estado=="Ocupado"){?>
                                ...
                                <td bgcolor="#CA2A14" ><img src="imagenes/car-Ocupadoo.svg" alt="" width="30" ><br><?php echo "Num: ". $id."<br> Id Cajon: ".$id."<br>Estado: ".$estado."<br>" ?>
